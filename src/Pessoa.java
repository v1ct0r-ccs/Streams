...
public class Pessoa {
    ...
    public List<Pessoa> popularPessoa(){
        Pessoa pessoa1 = new Pessoa("p1", "Felipe Drugovic", "Brasil", 23);
        Pessoa pessoa2 = new Pessoa("p2", "Max Verstappen", "Holanda", 25);
        Pessoa pessoa3 = new Pessoa("p3", "Lewis Hamilton", "Inglaterra", 38);
        Pessoa pessoa4 = new Pessoa("p4", "Fernando Alonso", "Espanha", 41);
